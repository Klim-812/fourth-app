...
fun main() {
    ...
    val result = if (melomans == true) {
        if (totalPrice > discountStart && totalPrice < discountNext) totalPrice - discount - resultDiscount
        else if (totalPrice > discountNext) totalPrice - percentDiscount - resultPercentDiscount
        else totalPrice
    } else {
        if (totalPrice > discountStart && totalPrice < discountNext) totalPrice - discount
